...
package com.jn.langx.security._jdk6jssejar.sun.security.ec;
...
public final class ECKeyFactory extends KeyFactorySpi {
    ...
    static {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Void>() {
            public Void run() {
                p.put("KeyFactory.EC", "com.jn.langx.security.jsse.sun.security.ec.ECKeyFactory");
                p.put("AlgorithmParameters.EC", "com.jn.langx.security.jsse.sun.security.ec.ECParameters");
