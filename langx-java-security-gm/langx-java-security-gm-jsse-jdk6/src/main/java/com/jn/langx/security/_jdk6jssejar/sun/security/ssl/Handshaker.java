...
import com.jn.langx.security._jdk6jssejar.sun.security.internal.spec.TlsKeyMaterialParameterSpec;
import com.jn.langx.security._jdk6jssejar.sun.security.internal.spec.TlsKeyMaterialSpec;
import com.jn.langx.security._jdk6jssejar.sun.security.internal.spec.TlsMasterSecretParameterSpec;
...
import com.jn.langx.security._jdk6jssejar.sun.security.ssl.HandshakeMessage.*;
import com.jn.langx.security._jdk6jssejar.sun.security.ssl.CipherSuite.*;
...
abstract class Handshaker {
    ...
    static final boolean allowUnsafeRenegotiation = Debug.getBooleanProperty(
            "com.jn.langx.security.jsse.com.jn.langx.security.jsse.com.jn.langx.security.jsse.sun.security.ssl.allowUnsafeRenegotiation", false);
    ...
    static final boolean allowLegacyHelloMessages = Debug.getBooleanProperty(
            "com.jn.langx.security.jsse.com.jn.langx.security.jsse.com.jn.langx.security.jsse.sun.security.ssl.allowLegacyHelloMessages", true);
                ...
                for (CipherSuite suite : enabledCipherSuites.collection()) {
                    if (suite.obsoleted > activeProtocols.min.v &&
                        ...
                        if (algorithmConstraints.permits(
                                EnumSet.of(com.jn.langx.security._jdk6jssejar.sun.security.util.CryptoPrimitive.KEY_AGREEMENT),
                                suite.name, null)) {
    ...
    ProtocolList getActiveProtocols() {
        if (activeProtocols == null) {
            ...
            EnumSet<com.jn.langx.security._jdk6jssejar.sun.security.util.CryptoPrimitive> cryptoPrimitives =
                    EnumSet.<com.jn.langx.security._jdk6jssejar.sun.security.util.CryptoPrimitive>of(com.jn.langx.security._jdk6jssejar.sun.security.util.CryptoPrimitive.KEY_AGREEMENT);
    ...
    private SecretKey calculateMasterSecret(SecretKey preMasterSecret,
        ...
        if (session.getUseExtendedMasterSecret()) {
            ...
            spec = new TlsMasterSecretParameterSpec(preMasterSecret, protocolVersion.major, protocolVersion.minor, sessionHash);
        } else {
            masterAlg = "SunTlsMasterSecret";
            spec = new TlsMasterSecretParameterSpec(preMasterSecret, protocolVersion.major, protocolVersion.minor,
