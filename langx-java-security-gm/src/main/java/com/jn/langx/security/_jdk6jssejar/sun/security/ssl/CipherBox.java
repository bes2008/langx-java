...
import com.jn.langx.security._jdk6jssejar.sun.misc.HexDumpEncoder;
...
final class CipherBox {
     ...
     */
    private CipherBox(ProtocolVersion protocolVersion, CipherSuite.BulkCipher bulkCipher,
     ...
     */
    static CipherBox newCipherBox(ProtocolVersion version, CipherSuite.BulkCipher cipher,
                                  SecretKey key, IvParameterSpec iv, SecureRandom random,
                                  boolean encrypt) throws NoSuchAlgorithmException {
