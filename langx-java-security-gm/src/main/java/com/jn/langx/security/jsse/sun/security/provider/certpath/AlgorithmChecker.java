...
package com.jn.langx.security.jsse.sun.security.provider.certpath;
...
import com.jn.langx.security.jsse.sun.security.validator.Validator;
            ...
            if (!constraints.permits(primitives, currPubKey)) {
                throw new CertPathValidatorException(
                        "Algorithm constraints check failed on key " +
                                ...
                                com.jn.langx.security.jsse.sun.security.util.KeyUtil.getKeySize(currPubKey) +
                                "bits");
            }
        }
