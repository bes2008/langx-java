...
import com.jn.langx.security._jdk6jssejar.sun.security.util.CryptoPrimitive;
import com.sun.net.ssl.internal.ssl.X509ExtendedTrustManager;

import static com.jn.langx.security._jdk6jssejar.sun.security.ssl.CipherSuite.KeyExchange.*;
...
final class ClientHandshaker extends Handshaker {
        ...
        switch (type) {
            ...
            case HandshakeMessage.ht_server_key_exchange:
                ...
                switch (keyExchange) {
                    ...
                    case K_DH_ANON:
                        try {
                            this.serverKeyExchange(new HandshakeMessage.DH_ServerKeyExchange(input));
                        } catch (GeneralSecurityException e) {
                            throwSSLException("Server key", e);
                        }
                        break;
            ...
            case HandshakeMessage.ht_certificate_request:
                ...
                certRequest = new HandshakeMessage.CertificateRequest(input);
            ...
            case HandshakeMessage.ht_finished:
                ...
                this.serverFinished(new HandshakeMessage.Finished(protocolVersion, input));
                break;
                    ...
                    try {
                        subject = AccessController.doPrivileged(
                            ...
                            public Subject run() throws Exception {
                                return Krb5Util.getSubject(GSSCaller.CALLER_SSL_CLIENT, getAccSE());
                            }});
    ...
    private void serverKeyExchange(HandshakeMessage.RSA_ServerKeyExchange mesg)
        ...
        if (!algorithmConstraints.permits(
                EnumSet.<com.jn.langx.security._jdk6jssejar.sun.security.util.CryptoPrimitive>of(com.jn.langx.security._jdk6jssejar.sun.security.util.CryptoPrimitive.KEY_AGREEMENT), ephemeralServerKey)) {
    ...
    private void serverFinished(HandshakeMessage.Finished mesg) throws IOException {
        ...
        boolean verified = mesg.verify(protocolVersion, handshakeHash,
                HandshakeMessage.Finished.SERVER, session.getMasterSecret());
    ...
    private void sendChangeCipherAndFinish(boolean finishedTag)
        ...
        HandshakeMessage.Finished mesg = new HandshakeMessage.Finished(protocolVersion, handshakeHash,
                HandshakeMessage.Finished.CLIENT, session.getMasterSecret());
