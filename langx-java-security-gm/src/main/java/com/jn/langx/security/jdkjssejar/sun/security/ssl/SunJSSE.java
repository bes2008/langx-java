...
public abstract class SunJSSE extends java.security.Provider {
    ...
    private void doRegister(boolean isfips) {
        ...
        put("Signature.MD5andSHA1withRSA",
                "com.jn.langx.security.jsse.sun.security.ssl.RSASignature");

        put("KeyManagerFactory.SunX509",
                "com.jn.langx.security.jsse.sun.security.ssl.KeyManagerFactoryImpl$SunX509");
        put("KeyManagerFactory.NewSunX509",
                "com.jn.langx.security.jsse.sun.security.ssl.KeyManagerFactoryImpl$X509");
        put("TrustManagerFactory.SunX509",
                "com.jn.langx.security.jsse.sun.security.ssl.TrustManagerFactoryImpl$SimpleFactory");
        put("TrustManagerFactory.PKIX",
                "com.jn.langx.security.jsse.sun.security.ssl.TrustManagerFactoryImpl$PKIXFactory");
        put("Alg.Alias.TrustManagerFactory.SunPKIX", "PKIX");
        put("Alg.Alias.TrustManagerFactory.X509", "PKIX");
        put("Alg.Alias.TrustManagerFactory.X.509", "PKIX");

        put("SSLContext.TLSv1",
                "com.jn.langx.security.jsse.sun.security.ssl.SSLContextImpl$TLS10Context");
        ...
        put("SSLContext.TLSv1.1",
                "com.jn.langx.security.jsse.sun.security.ssl.SSLContextImpl$TLS11Context");
        put("SSLContext.Default",
                "com.jn.langx.security.jsse.sun.security.ssl.SSLContextImpl$DefaultSSLContext");
