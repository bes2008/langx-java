...
import static com.jn.langx.security.jdkjssejar.sun.security.ssl.CipherSuite.KeyExchange.*;
...
final class ClientHandshaker extends Handshaker {
    ...
    private void serverKeyExchange(HandshakeMessage.RSA_ServerKeyExchange mesg)
        ...
        if (!algorithmConstraints.permits(
                EnumSet.<com.jn.langx.security.jdkjssejar.sun.security.util.CryptoPrimitive>of(com.jn.langx.security.jdkjssejar.sun.security.util.CryptoPrimitive.KEY_AGREEMENT), ephemeralServerKey)) {
