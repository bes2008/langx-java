...
public class Java8CandidatePatternsDateTimeParser implements DateTimeParser {
    ...
    public DateTimeParsedResult parse(final String datetimeString) {
        ...
        Collects.forEach(formatCacheKeys, new Consumer<DateFormatCacheKey>() {
            ...
            public void accept(DateFormatCacheKey dateFormatCacheKey) {
                DateTimeParsedResult r = new Java8DateTimeParser(dateFormatCacheKey.pattern, TimeZone.getTimeZone(dateFormatCacheKey.timeZoneId), dateFormatCacheKey.locale).parse(datetimeString);
                if (r != null) {
                    resultHolder.set(r);
    ...
    public Java8CandidatePatternsDateTimeParser addTimeZone(final TimeZone timeZone) {
        if (timeZone != null) {
    ...
    public Java8CandidatePatternsDateTimeParser addLocale(final Locale locale) {
        if (locale != null) {
