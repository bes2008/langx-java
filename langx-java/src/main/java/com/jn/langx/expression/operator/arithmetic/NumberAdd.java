...
public class NumberAdd extends AbstractBinaryOperator<NumberExpression<Number>, NumberExpression<Number>, NumberExpression<Number>> implements Add<NumberExpression<Number>, NumberExpression<Number>, NumberExpression<Number>> {

    public NumberAdd() {
    }

    public NumberAdd(NumberExpression<Number> left, NumberExpression<Number> right) {
        this.setLeft(left);
        this.setRight(right);
    }

    public NumberAdd(String operateSymbol, NumberExpression<Number> left, NumberExpression<Number> right) {
        this(left, right);
