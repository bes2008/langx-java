...
public class HashTrie<T> implements Trie<T>
{
    private static class Entry<T> implements Map.Entry<CharSequence,T>
    {
        ...
        {
            return (Objs.equals(key, other.getKey()) && Objs.equals(value, other.getValue()));
        }
        ...
        public int hashCode()
        {
            return Objs.hashCode(key) ^ Objs.hashCode(value);
        }

        @Override
        public String toString()
        {
            return Objs.toString(key) + " => " + Objs.toString(value);
        }
    }
