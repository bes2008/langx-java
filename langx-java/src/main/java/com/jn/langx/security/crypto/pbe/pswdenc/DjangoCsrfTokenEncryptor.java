...
public class DjangoCsrfTokenEncryptor implements PasswordEncryptor {
     ...
     */
    @Override
    public boolean check(String csrfToken, String csrfMiddlewareToken) {
        String csrfTokenSecret = decrypt(csrfToken);
        String csrfMiddlewareTokenSecret = decrypt(csrfMiddlewareToken);
        return Objs.equals(csrfTokenSecret, csrfMiddlewareTokenSecret);
    }
