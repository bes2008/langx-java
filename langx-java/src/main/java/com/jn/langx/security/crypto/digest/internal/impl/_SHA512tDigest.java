...
public final class _SHA512tDigest extends _AbstractLongDigest {
     ...
     */
    public _SHA512tDigest(int bitLength) {
        if (bitLength >= 512) {
     ...
     * message digest.
     */
    public _SHA512tDigest(_SHA512tDigest t) {
        super(t);
    ...
    public _SHA512tDigest(byte[] encodedState) {
        this(readDigestLength(encodedState));
        restoreState(encodedState);
    }

    private static int readDigestLength(byte[] encodedState) {
        return Bytes.bigEndianToInt(encodedState, encodedState.length - 4);
    }
    ...
    public Memoable copy() {
        return new _SHA512tDigest(this);
    }

    public void reset(Memoable other) {
        _SHA512tDigest t = (_SHA512tDigest) other;
    ...
    public byte[] getEncodedState() {
        ...
        Bytes.intToBigEndian(digestLength * 8, encoded, baseSize);
        return encoded;
    }
}
