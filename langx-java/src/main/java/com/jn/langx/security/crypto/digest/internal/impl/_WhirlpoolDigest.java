...
public final class _WhirlpoolDigest implements Memoable, Digest {
     ...
     * digest.
     */
    public _WhirlpoolDigest(_WhirlpoolDigest originalDigest) {
    ...
    public Memoable copy() {
        return new _WhirlpoolDigest(this);
    }

    public void reset(Memoable other) {
        _WhirlpoolDigest originalDigest = (_WhirlpoolDigest) other;
