...
class Sha2Crypt {
     ...
     * <p>
     * See {@link GlibcCrypt#crypt(String, String)} for details.
     * </p>
     * <p>
    ...
    public static String sha256Crypt(final byte[] keyBytes, String salt) {
        ...
        return sha2Crypt(keyBytes, salt, SHA256_PREFIX, SHA256_BLOCKSIZE, JCAEStandardName.SHA_256.getName());
    }
    ...
    private static String sha2Crypt(final byte[] keyBytes, final String salt, final String saltPrefix,
        ...
        MessageDigest ctx = MessageDigests.getDigest(algorithm);
         ...
         * context.
         */
        MessageDigest altCtx = MessageDigests.getDigest(algorithm);
         ...
         */
        altCtx = MessageDigests.getDigest(algorithm);
        ...
        for (int i = 0; i <= rounds - 1; i++) {
             ...
             * New context.
             */
            ctx = MessageDigests.getDigest(algorithm);
    ...
    public static String sha512Crypt(final byte[] keyBytes, String salt) {
        ...
        return sha2Crypt(keyBytes, salt, SHA512_PREFIX, SHA512_BLOCKSIZE, SHA_512);
    }
