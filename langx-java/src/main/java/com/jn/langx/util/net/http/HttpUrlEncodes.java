...
import com.jn.langx.util.net.http.url.CharArrayBuffer;
import com.jn.langx.util.net.http.url.TokenParser;
import com.jn.langx.util.net.http.url.ParserCursor;
