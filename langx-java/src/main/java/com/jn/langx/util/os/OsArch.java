...
public enum OsArch implements CommonEnum {
    ...
    AARCH64(3003, "aarch64", "64 位 ARM 架构", OsArchSeries.ARM, 64,"aarch-64","aarch_64"), // ARM v8
    PPCLE64(4001, "ppcle64", "64 位 PowerPC 架构", OsArchSeries.POWER, 64, "ppcle_64","ppcle-64"),
    PPC64(4002, "ppc64", "64 位 PowerPC 架构", OsArchSeries.POWER, 64,"ppc-64","ppc_64"),
    POWERPC(4003, "powerpc", "32 位 PowerPC 架构", OsArchSeries.POWER, 32, "ppc", "power"),
    S390X(5001, "s390x", "64 位 IBM System z 架构", OsArchSeries.Z, 64,"s390_64","s390-64"),
    S390(5002, "s390", "32 位 IBM System z 架构", OsArchSeries.Z, 32),
    MIPS64(6001, "mips64", "64 位 MIPS 架构", OsArchSeries.MIPS, 64,"mips_64","mips-64"),
    MIPS(6002, "mips", "32 位 MIPS 架构", OsArchSeries.MIPS, 32),
    SPARC_V9(7001, "sparcv9", "64 位 SPARC 架构", OsArchSeries.SPARC, 64,"sparcv9_64","sparcv9_64"),
    ...
    LOONGARCH64(10001, "loongarch64", "64 位龙芯架构", OsArchSeries.LOONGARCH, 64, "loongarch_64", "loongarch-64"),
    LOONGARCH(10002, "loongarch", "32 位龙芯架构", OsArchSeries.LOONGARCH, 32),

    RISC_V_64(11001, "riscv64", "64 位RISC-V架构",OsArchSeries.RISC_V,64, "riscv-64","riscv_64","risc-v-64","risc-v_64","risc_v-64","risc_v_64"),
