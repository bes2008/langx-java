...
public class MediaType extends MimeType implements Serializable {
    ...
    static {
        ...
        APPLICATION_JSON_UTF8 = new MediaType("application", "json", Charsets.UTF_8);
        APPLICATION_OCTET_STREAM = new MediaType("application", "octet-stream");
        APPLICATION_PDF = new MediaType("application", "pdf");
        APPLICATION_PROBLEM_JSON = new MediaType("application", "problem+json");
        APPLICATION_PROBLEM_JSON_UTF8 = new MediaType("application", "problem+json", Charsets.UTF_8);
    ...
    public MediaType(String type, String subtype) {
        super(type, subtype, Collects.<String, String>emptyHashMap());
    }
    ...
    protected void checkParameters(String attribute, String value) {
        ...
        if (PARAM_QUALITY_FACTOR.equals(attribute)) {
            ...
            Preconditions.checkTrue(d >= 0D && d <= 1D,
    ...
    public static List<MediaType> parseMediaTypes(@Nullable String mediaTypes) {
        if (!Strings.isNotEmpty(mediaTypes)) {
