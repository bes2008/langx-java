...
public final class CronExpression implements Serializable, Cloneable {
    ...
    static {
        ...
        monthmap.put("NOV", 10);
        monthmap.put("DEC", 11);
        monthMap = Collections.unmodifiableMap(monthmap);

        Map<String, Integer> daymap = new HashMap<String, Integer>(7);
        daymap.put("SUN", 1);
        daymap.put("MON", 2);
        daymap.put("TUE", 3);
        daymap.put("WED", 4);
        ...
        daymap.put("FRI", 6);
        daymap.put("SAT", 7);
        dayMap = Collections.unmodifiableMap(daymap);
    }
