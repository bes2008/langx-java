...
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    public MimeType(String type, String subtype) {
        this(type, subtype, Collects.<String, String>emptyHashMap());
    }
    ...
    public MimeType(String type, String subtype, @Nullable Map<String, String> parameters) {
        Preconditions.checkNotEmpty(type, "'type' must not be empty");
        Preconditions.checkNotEmpty(subtype, "'subtype' must not be empty");
        checkToken(type);
        checkToken(subtype);
        ...
        if (!Emptys.isEmpty(parameters)) {
            ...
            Collects.forEach(parameters, new Consumer2<String, String>() {
                @Override
    ...
    protected void checkParameters(String attribute, String value) {
        Preconditions.checkNotEmpty(attribute, "'attribute' must not be empty");
