...
public final class IPv6AddressPool implements Serializable {
    ...
    private void validateFreeRanges(IPv6AddressRange range, SortedSet<IPv6AddressRange> toValidate) {
        ...
        // some more validations would be useful. For example the free ranges should be defragmented and non overlapping etc
    }
    ...
    public boolean equals(Object o) {
        ...
        if (freeRanges != null ? !freeRanges.equals(that.freeRanges) : that.freeRanges != null) {
            return false;
        }
        if (lastAllocated != null ? !lastAllocated.equals(that.lastAllocated) : that.lastAllocated != null) {
            return false;
        }
        if (underlyingRange != null ? !underlyingRange.equals(that.underlyingRange) : that.underlyingRange != null) {
            return false;
        }
