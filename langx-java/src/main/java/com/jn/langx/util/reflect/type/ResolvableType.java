...
public class ResolvableType implements Serializable {
    ...
    private boolean isAssignableFrom(ResolvableType other, Map<Type, Type> matchedBefore) {
        Preconditions.checkNotNull(other, "ResolvableType must not be null");
        ...
        if (exactMatch ? !ourResolved.equals(otherResolved) : !Reflects.isSubClassOrEquals(ourResolved, otherResolved)) {
            return false;
        }
    ...
    public ResolvableType as(Class<?> type) {
        ...
        if (Objs.deepEquals(resolve(), type)) {
            return this;
        }
    ...
    public ResolvableType[] getInterfaces() {
        Class<?> resolved = resolve();
        if (resolved == null || Objs.isEmpty(resolved.getGenericInterfaces())) {
    ...
    private Type resolveBounds(Type[] bounds) {
        if (Objs.isEmpty(bounds) || Object.class == bounds[0]) {
            return null;
        }
        return bounds[0];
    }
    ...
    private ResolvableType resolveVariable(TypeVariable<?> variable) {
        ...
        if (this.type instanceof ParameterizedType) {
            ...
            for (int i = 0; i < variables.length; i++) {
                if (Objs.deepEquals(variables[i].getName(), variable.getName())) {
    ...
    public boolean equals(Object other) {
        ...
        if (!Objs.deepEquals(this.type, otherType.type)) {
            return false;
        }
        if (this.typeProvider != otherType.typeProvider &&
                (this.typeProvider == null || otherType.typeProvider == null ||
                        !Objs.deepEquals(this.typeProvider.getType(), otherType.typeProvider.getType()))) {
            return false;
        }
    ...
    private int calculateHashCode() {
        int hashCode = Objs.hashCode(this.type);
        if (this.typeProvider != null) {
            hashCode = 31 * hashCode + Objs.hashCode(this.typeProvider.getType());
        }
        if (this.variableResolver != null) {
            hashCode = 31 * hashCode + Objs.hashCode(this.variableResolver.getSource());
        }
        if (this.componentType != null) {
            hashCode = 31 * hashCode + Objs.hashCode(this.componentType);
        }
        return hashCode;
    }
    ...
    public String toString() {
        ...
        if (hasGenerics()) {
            result.append('<');
            result.append(Strings.join(", ",getGenerics()));
            result.append('>');
        }
    ...
    public static ResolvableType forRawClass(Class<?> clazz) {
        return new ResolvableType(clazz) {
            ...
            @Override
            public boolean isAssignableFrom(Class<?> other) {
                return Reflects.isSubClassOrEquals(getRawClass(), other);
            }
            @Override
            public boolean isAssignableFrom(ResolvableType other) {
                Class<?> otherClass = other.getRawClass();
                return (otherClass != null && Reflects.isSubClassOrEquals(getRawClass(), otherClass));
            }
        };
    }
    ...
    public static ResolvableType forClass(Class<?> baseType, Class<?> implementationClass) {
        Preconditions.checkNotNull(baseType, "Base type must not be null");
    ...
    public static ResolvableType forClassWithGenerics(Class<?> clazz, Class<?>... generics) {
        ...
        Preconditions.checkNotNull(generics, "Generics array must not be null");
    ...
    public static ResolvableType forClassWithGenerics(Class<?> clazz, ResolvableType... generics) {
        ...
        Preconditions.checkTrue(variables.length == generics.length, "Mismatched number of generics specified");
    ...
    public static ResolvableType forMethodParameter(SimpleParameter methodParameter, ResolvableType implementationType) {
        Preconditions.checkNotNull(methodParameter, "MethodParameter must not be null");
    ...
    public static ResolvableType forArrayComponent(ResolvableType componentType) {
        Preconditions.checkNotNull(componentType, "Component type must not be null");
