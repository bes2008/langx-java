        ...
        implements Serializable, Appendable
{
     ...
     */
    @NonNull private static final byte[] TRUE_VALUE_BYTES =Utf8s.getBytes("true");
     ...
     */
    @NonNull private static final ThreadLocal<byte[]> TEMP_NUMBER_BUFFER =
