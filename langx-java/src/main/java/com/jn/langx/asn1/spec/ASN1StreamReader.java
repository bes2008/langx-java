...
public final class ASN1StreamReader
     ...
     */
    public ASN1StreamReader(@NonNull final InputStream inputStream) {
     ...
     */
    void setSASLClient(@NonNull final SaslClient saslClient) {
        ...
        for (int i = 0; i < numLengthBytes; i++) {
            ...
            if (b < 0) {
                if ((i == 0) && (firstByte < 0)) {
                    ...
                    saslInputStream = new ByteArrayInputStream(Emptys.EMPTY_BYTES);
                } else {
