...
public class OpenSSLDSATests {
    ...
    @Test
    public void test() {
        Resource privateResource = Resources.loadClassPathResource("/security/dsa/data/openssl/mydsa_pri_pkcs8.pem");
        ...
        Resource publicResource =   Resources.loadClassPathResource("/security/dsa/data/openssl/mydsa_pub.pem");
