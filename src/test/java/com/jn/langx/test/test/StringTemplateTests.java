...
public class StringTemplateTests {
    ...
    private void testFormatBasedOrder(Object[] args) {
        System.out.println(StringTemplates.formatBasedOrder("", args));
        System.out.println(StringTemplates.formatBasedOrder(" \t ", args));
        System.out.println(StringTemplates.formatBasedOrder(" a, b, c ", args));
        System.out.println(StringTemplates.formatBasedOrder(" a{}, b{1}, c{2} ", args));
        System.out.println(StringTemplates.formatBasedOrder(" a{1}, b{}, c{3} ", args));
        System.out.println(StringTemplates.formatBasedOrder(" a{0}, b{}, c{} ", args));
    }
