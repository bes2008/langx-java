...
public class JarFile extends java.util.jar.JarFile {
    ...
    private Supplier0<Manifest> manifestSupplier;
    ...
    private JarFile(RandomAccessDataFile rootFile, String pathFromRoot, RandomAccessData data, JarEntryFilter filter,
                    JarFileType type, Supplier0<Manifest> manifestSupplier) throws IOException {
        ...
        this.manifestSupplier = (manifestSupplier != null) ? manifestSupplier : new Supplier0<Manifest>() {
            @Override
            public Manifest get() {
