 ...
 * interface { CompletionStep} with the following policies: <ul>
 * <p>
 ...
 * <p>
 * <li>All CompletionStep methods are implemented independently of
 * other public methods, so the behavior of one method is not impacted
 * by overrides of others in subclasses.  </li> </ul>
 * <p>
 * <p>CompletableFuture also implements { Future} with the following
 * policies: <ul>
 * <p>
 * <li>Since (unlike { FutureTask}) this class has no direct
...
public class CompletableFuture<T> implements Future<T>, CompletionStep<T> {
    ...
    static final class UniWhenComplete<T> extends UniCompletion<T, T> {
        Consumer2<? super T, ? super Throwable> fn;
    ...
    final boolean uniWhenComplete(CompletableFuture<T> a, Consumer2<? super T, ? super Throwable> f, UniWhenComplete<T> c) {
        Object r;
        T t;
        Throwable x = null;
        if (a == null || (r = a.result.get()) == null || f == null) {
    ...
    private CompletableFuture<T> uniWhenCompleteStage(Executor e, Consumer2<? super T, ? super Throwable> f) {
        if (f == null) {
            throw new NullPointerException();
        }
    ...
    static final class UniHandle<T, V> extends UniCompletion<T, V> {
        Function2<? super T, Throwable, ? extends V> fn;
    ...
    final <S> boolean uniHandle(CompletableFuture<S> a,
                                Function2<? super S, Throwable, ? extends T> f,
                                UniHandle<S, T> c) {
        Object r;
        S s;
        Throwable x;
    ...
    private <V> CompletableFuture<V> uniHandleStage(
            Executor e, Function2<? super T, Throwable, ? extends V> f) {
        if (f == null) {
            throw new NullPointerException();
        }
        CompletableFuture<V> d = new CompletableFuture<V>();
    ...
    static final class UniCompose<T, V> extends UniCompletion<T, V> {
        Function<? super T, ? extends CompletionStep<V>> fn;
    ...
    final <S> boolean uniCompose(
            ...
            Function<? super S, ? extends CompletionStep<T>> f,
            UniCompose<S, T> c) {
        Object r;
        Throwable x;
        if (a == null || (r = a.result.get()) == null || f == null) {
    ...
    private <V> CompletableFuture<V> uniComposeStage(
            Executor e, Function<? super T, ? extends CompletionStep<V>> f) {
        if (f == null) {
            throw new NullPointerException();
        }
        Object r;
    ...
    private CompletableFuture<Void> biRunStage(Executor e, CompletionStep<?> o,
                                               Runnable f) {
        CompletableFuture<?> b;
        if (f == null || (b = o.toCompletableFuture()) == null) {
            throw new NullPointerException();
        ...
        if (e != null || !d.biRun(this, b, f, null)) {
            BiRun<T, Object> c = new BiRun(e, d, this, b, f);
            bipush(b, c);
            c.tryFire(SYNC);
        }
        return d;
    ...
    private <U extends T> CompletableFuture<Void> orAcceptStage(
            Executor e, CompletionStep<U> o, Consumer<? super T> f) {
        CompletableFuture<U> b;
        if (f == null || (b = o.toCompletableFuture()) == null) {
            throw new NullPointerException();
        }
    ...
    private CompletableFuture<Void> orRunStage(Executor e, CompletionStep<?> o,
                                               Runnable f) {
        CompletableFuture<?> b;
        if (f == null || (b = o.toCompletableFuture()) == null) {
            throw new NullPointerException();
    ...
    static final class AsyncSupply<T> implements Runnable, AsynchronousCompletionTask {
        ...
        AsyncSupply(CompletableFuture<T> dep, Supplier0<T> fn) {
            this.dep = dep;
            this.fn = fn;
        }
    ...
    public <U, V> CompletableFuture<V> thenCombineAsync(
            CompletionStep<? extends U> other,
            Function2<? super T, ? super U, ? extends V> fn, Executor executor) {
    ...
    public <U> CompletableFuture<Void> thenAcceptBothAsync(
            CompletionStep<? extends U> other,
            Consumer2<? super T, ? super U> action, Executor executor) {
        return biAcceptStage(screenExecutor(executor), other, action);
    }

    public CompletableFuture<Void> runAfterBoth(CompletionStep<?> other,
                                                Runnable action) {
        return biRunStage(null, other, action);
    }

    public CompletableFuture<Void> runAfterBothAsync(CompletionStep<?> other,
                                                     Runnable action) {
    ...
    public <U> CompletableFuture<U> applyToEither(
            CompletionStep<? extends T> other, Function<? super T, U> fn) {
    ...
    public CompletableFuture<Void> acceptEither(
            CompletionStep<? extends T> other, Consumer<? super T> action) {
    ...
    public CompletableFuture<Void> runAfterEither(CompletionStep<?> other,
                                                  Runnable action) {
        return orRunStage(null, other, action);
    }

    public CompletableFuture<Void> runAfterEitherAsync(CompletionStep<?> other,
                                                       Runnable action) {
    ...
    public CompletableFuture<T> whenCompleteAsync(
            Consumer2<? super T, ? super Throwable> action, Executor executor) {
    ...
    public <U> CompletableFuture<U> handleAsync(
            Function2<? super T, Throwable, ? extends U> fn, Executor executor) {
    ...
    // not in interface CompletionStep
